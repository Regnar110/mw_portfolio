...
const Projects = () => {
  return (
    <div className='projects flex flex-col rounded-lg'>
        ...
        <div className='project_list font-press w-full flex flex-col gap-5'>
            <div className='single_project w-full flex flex-col xl:flex-row overflow-hidden'>
                <Image className='w-full xl:w-1/2' src={apart} alt='apart' />
                <div className='single_project_desc xl:w-1/2 flex flex-col items-center gap-5  p-4'>
